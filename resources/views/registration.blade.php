        ...
        <form class="form-horizontal">
            <div class="form-group">
                ...
                <div class="col-lg-9 col-md-9 col-sm-9">
                    <input type="string" class="form-control size-14" id="inputLastName" name="lastName">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-lg-9 col-md-9 col-sm-9">
                    <input type="string" class="form-control size-14" id="inputFirstName" name="firstName">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-lg-9 col-md-9 col-sm-9">
                    <input type="string" class="form-control size-14" id="inputMiddleInitial" name="mi">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-lg-9 col-md-9 col-sm-9">
                    <input type="email" class="form-control size-14" id="inputEmail" name="email">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-9 col-md-9 col-sm-9">
                    <input type="password" class="form-control size-14" id="inputPassword" name="password">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-lg-9 col-md-9 col-sm-9">
                    <input type="password" class="form-control size-14" id="confirm_password" name="password_confirmation">
                </div>
            </div>
